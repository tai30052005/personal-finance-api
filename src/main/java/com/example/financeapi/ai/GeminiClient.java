...
/**
 * Lớp gọi Google Gemini dùng chung (nhập-tay + chat phân tích).
 * Gói gọn: cấu hình key/model, gọi generateContent, tự thử lại khi 5xx,
 * và map lỗi HTTP (429 hết lượt / 503 quá tải / khác) thành thông báo thân thiện.
 */
@Component
public class GeminiClient {
    ...
    /** Có cấu hình key hay chưa (để frontend ẩn/hiện tính năng AI). */
